  ...
  return (
    <div className="h-[50vh] py-10 w-full bg-[#E4E4E4] px-10">
      <h1 className="text-black text-2xl mb-[2vw] font-medium ">
        ...
        veroveren. Geobsedeerd door de magie van design, geloven we sterk in de
        kracht van 'story-driven design'; <br />
        het geeft jouw unieke merkverhaal geloofwaardigheid, zeggingskracht en
